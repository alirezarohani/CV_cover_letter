...
\renewcommand{\refname}{\color{awesome-red}A\color{black}PPENDICES}
...
\name{Alireza}{Rohani}
\position{Research Scientist{\enskip\cdotp\enskip}Security Expert}
%\address{246-1002, Gwangmyeongmayrouge Apt. 86, Cheongna lime-ro, Seo-gu, Incheon-si, 404-180, Rep. of KOREA}

\mobile{(+65) 84-2364-18}
\email{alireza.rohani1@gmail.com}
